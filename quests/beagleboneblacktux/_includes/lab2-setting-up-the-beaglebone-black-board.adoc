...
"<<Getting Comfortable With The Board>> section and should be easy to locat
 with the labelled image in that section.

It would be good to read the section on the debug serial header given in the
