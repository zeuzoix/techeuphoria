...
U-Boot#
----
<1> We run the _picocom_ application setting the baud rate to 115200 and choosing the device as _/dev/ttyUSB0_
<2> _picocom_ shows that the terminal is ready after printing the serial port settings
