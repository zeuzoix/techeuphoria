...
include::{includedir}/lab1-getting-accustomed-to-browsing-the-sources.adoc[]
...
include::{includedir}/lab2-setting-up-the-beaglebone-black-board.adoc[]

include::{includedir}/lab3-cross-compile-kernel-and-boot-from-workstation.adoc[]
